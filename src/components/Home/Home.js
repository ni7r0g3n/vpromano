...
function Home({onClick, onImageLoad, markers, loading, imageRef}) {
    ...
    return (
        <div style={{height: "100vh", display: "flex", flexDirection:"column", justifyContent: "center", alignItems: "center"}}>
            ...
            <img ref={imageRef} onLoad={onImageLoad} className={`${loading ? null : "fadeIn"} main-image`} style={{maxHeight: "100vh", maxWidth: "100vw", zIndex:98, visibility: loading ? "hidden" : "visible"}} src={"/vpromano/Image65.png"} onClick={onClick}/>
            {markers}
            {loading ? <Loader/> : null}
        </div>
