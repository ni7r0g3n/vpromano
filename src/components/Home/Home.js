...
function Home({onClick, onImageLoad, markers, loading}) {
    ...
    return (
        <div style={{height: "100vh", display: "flex", flexDirection:"column", justifyContent: "center", alignItems: "center"}}>
            ...
            <img onLoad={onImageLoad} className={loading ? null : "fadeIn"} style={{maxHeight: "100vh", maxWidth: "100vw", zIndex:98, visibility: loading ? "hidden" : "visible"}} src={"/residence-ar/Image65.png"} onClick={onClick}/>
            {markers}
            {loading ? <Loader/> : null}
        </div>
